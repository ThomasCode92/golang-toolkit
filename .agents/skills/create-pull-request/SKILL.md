...
Every pull request contains code of a specific module of a Udemy course. The
branch name is related to the name of the module, the name of the Udemy course
...
1. **Udemy Course**: If the related Udemy course is not clear from the context,
...
3. **Type of Change**: Bug fix, new feature, breaking change, refactor,
   cosmetic, documentation, or workflow
4. **Test Procedure**: How was this tested? What could break?

### Example clarifying question

If the Udemy course is not found:

> I couldn't find a related Udemy course in the commit messages or branch name.
> What Udemy course does this PR relate to? (Enter the course name or "None" if
> not applicable)
...
- Replace `[Name of the course]` with the actual Udemy course name.
